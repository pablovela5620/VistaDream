...
def get_parser():
    ...
    parser.add_argument(
        ...
        default=[
            ...
            False,
            "MODEL.WEIGHTS",
            "/mnt/proj/SOTAs/OneFormer-main/ckpts/coco_pretrain_1280x1280_150_16_dinat_l_oneformer_ade20k_160k.pth",
        ],
...
class OneFormer_Segment:
    def __init__(
        ...
        yaml="/mnt/proj/GaussianAnythingV2/Tools/OneFormer/configs/ade20k/dinat/coco_pretrain_oneformer_dinat_large_bs16_160k_1280x1280.yaml",
    ) -> None:
        self.ckpt = ckpt
        self.yaml = yaml
        self._setup()
    ...
    def _setup(self):
        ...
        # Don't parse command line args when used as a module
